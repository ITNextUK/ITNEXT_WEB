    ...
    <section className="relative pt-32 pb-32 lg:pt-56 lg:pb-72 px-6 bg-zinc-50 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center flex flex-col items-center relative z-10">
        ...
        <h1 className="text-4xl lg:text-6xl font-black text-brand-dark leading-[1.1] mb-10 tracking-tighter">
          Data-Driven Digital Systems <br />
          <span className="text-zinc-400">& AI Transformation.</span>
        </h1>
        
        <p className="text-xl text-zinc-500 max-w-2xl mb-16 leading-relaxed mx-auto font-medium">
          Strategic research, intelligent systems design, and expert transformation advisory for technology leaders and European enterprises.
        </p>
    ...
    <section className="py-32 px-6 bg-white border-y border-zinc-100">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
        <div>
          ...
          <h2 className="text-4xl lg:text-5xl font-black text-brand-dark mb-8 tracking-tight">Knowledge-Led Innovation</h2>
          <p className="text-xl text-zinc-500 leading-relaxed mb-8 font-medium">
            ITNEXT operates at the intersection of industry expertise and academic rigor. We are not a high-volume commercial agency; we are an exploratory innovation platform.
          </p>
          <p className="text-lg text-zinc-500 leading-relaxed font-medium">
            Our mission is to help organizations navigate the complex landscape of AI, cloud architecture, and data analytics through a research-driven lens that prioritizes long-term strategic value.
          </p>
        </div>
        <div className="grid grid-cols-2 gap-6">
          <div className="aspect-square bg-zinc-50 rounded-3xl flex flex-col justify-center p-10 border border-zinc-100 group hover:border-brand-accent transition-colors duration-500">
            <span className="text-5xl font-black text-brand-dark mb-4 group-hover:text-brand-accent transition-colors">18+</span>
            <span className="text-[10px] text-zinc-400 uppercase font-black tracking-[0.2em]">Years Experience</span>
          </div>
    ...
    <section className="py-32 px-6 bg-zinc-50">
      <div className="max-w-7xl mx-auto">
        <div className="mb-20 flex flex-col items-center text-center">
          ...
          <h3 className="text-5xl font-black text-brand-dark tracking-tight">Core Focus Areas</h3>
        </div>
    ...
    <div className="animate-in fade-in duration-700">
      ...
      <section className="py-32 px-6 bg-brand-dark text-white overflow-hidden relative">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-5xl font-black mb-10 tracking-tight">Ready to explore the next frontier of digital intelligence?</h2>
